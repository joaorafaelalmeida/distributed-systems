...
public class Parameters 
{
    ...
    public static final String nameEntryContestantBench = "ContestantBench";
    public static final String nameEntryPlayground = "Playground";
    public static final String nameEntryRefereeSite = "RefereeSite";
    public static final String nameEntryRepository = "Repository";
