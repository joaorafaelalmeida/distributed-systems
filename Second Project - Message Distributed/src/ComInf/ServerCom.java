...
public class ServerCom
{
   ...
   * @throws java.net.SocketTimeoutException socket timeout exception
   */
   ...
   public ServerCom accept () throws SocketTimeoutException
   {
      ...
      try    
      { 
          listeningSocket.setSoTimeout (15000); //15 segundos em caso de bloqueio evito matar processos
          if(timeActive)
